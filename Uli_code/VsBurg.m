...
% dist = 1250000 for age = 25Myr, 25000000 50My, 3750000 75My, 50000000 100My
% dist = 6250000 for age = 125Myr, 75000000 150My, 8750000 175My
...
fgs = 10E-3; % constant grain size in m
...
figure(1)
plot(Vs(2:lz)/1000,dk,'g')%,Vsanh(2:lz)/1000,dk,'k')
xlabel('Vs, km/s')
ylabel('Depth, km')
axis([4.1 4.9 -400 0])
